<template>
  ...
  >
    ...
    <v-toolbar-title
      ...
      v-text="$route.meta.pageTitle ? ($route.meta.pageTitle.i18n ? $t($route.meta.pageTitle.text) : $route.meta.pageTitle.text) : $route.name"
    />
    <v-spacer />
...
import { CURRENT_LANGUGE, ACTION_SET_LANG } from "@/store/storeConfig";
export default {
